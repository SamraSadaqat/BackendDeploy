...
const register = async (req, res) => {
  try {
    let { email, password, name, device_token, gender } = req.body; // Include fields for signup (e.g. password, name, gender)
    let obj = {};
    let Errors = [];
    ...
    // Gender validation: Only "Male" or "Female" are allowed
